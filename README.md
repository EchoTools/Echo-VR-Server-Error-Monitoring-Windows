...
Before you begin, download the game with [Mia's Installer](https://github.com/marshmallow-mia/Echo-VR-Installer/releases). Install the no license patch just in case.

Then, download EchoVR-Server-Setup.py from the code tab, [compile it](https://github.com/EchoTools/EchoVR-Windows-Hosts-Resources/wiki/Setup-Guide#compiling-scripts), and run it for a streamlined setup experience. <br>(binary release coming soon<sup>tm</sup>)
